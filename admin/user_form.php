    ...
    <main class="flex-1 flex flex-col">
        ...
        <div class="p-6 flex-1 max-w-xl">
            <div class="bg-white rounded-xl shadow-sm p-6">
                <form action="modulos.html" method="post">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="titulo" class="form-input" required placeholder="Digite seu email.">
                    </div>
                    <div class="mb-4">
                        <label class="form-label">Senha *</label>
                        <input type="password" name="titulo" class="form-input" required placeholder="Digite a sua senha.">
                    </div>
                    <div class="flex gap-2">
                        ...
                        <a href="index.html" class="bg-gray-100 text-gray-600 font-semibold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-200 transition">Cancelar</a>
                    </div>
                </form>
            </div>
        </div>
