...
<body class="bg-gray-50 min-h-screen flex flex-col">
    ...
    <nav class="bg-senai-blue shadow-md">
        <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <a href="cadastro.html" class="text-blue-200 hover:text-white text-sm transition">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div class="px-8 py-6">
                    ...
                    <!-- ALERTA DE ERRO (exemplo condicional PHP) -->
                    ...
                    <a href="cadastro.html" class="block w-full border-2 border-senai-blue text-senai-blue font-bold py-2.5 rounded-lg text-sm text-center hover:bg-blue-50 transition">
                        Criar nova conta
                    </a>
